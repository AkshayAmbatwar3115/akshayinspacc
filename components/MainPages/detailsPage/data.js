const DetailsPages = [
  {
    name: "Pest Control",
    link: "one_time_services/pest_control",
    bannerImage: "/images/DetailPage/bannerLogos/group-33.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    stepData: {
      ...
      step0: {
        // list: ["Residential", "Shop", "Office", "Hospital", "Bank"],
        list: ["Residential", "Corporate"],
      },
      step1: {
        isText: false,
        isResidential: true,
        ...
        listResidential: ["1 BHK", "2 BHK", "3 BHK", "Other"],
      },
    },
    bannerDetails: [
      "Inspacco as a platform provides experinced and professional certified pest control supplier partners for your residential gated communities to provide quality services as per the requirement",
      "Our technical platform helps to track complete scheulde of pest control AMC  and provide the convenience to committee members as well as supplier partners",
      "Get in touch with us and see how you can utilize it for your community.",
    ],
    qualityAssurance: [
...

  {
    ...
    link: "annual-services/cctv",
    bannerImage: "/images/DetailPage/bannerLogos/cctv.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    stepData: {
      ...
      step0: {
        // list: ["Residential", "Office", "Hospital", "Bank", "Other"],
        list: ["Residential", "Corporate"],
      },
      step1: {
        isText: false,
        isResidential: false,
        list: ["Installation", "Maintenance", "Repair & fixes", "AMC Contract"],
      },
    },
    bannerDetails: [
      "Inspacco platform provides professional CCTV installation and maintenance services for residential gated communities through our certified supplier partners",
      "Installing and maintaining CCTV cameras becomes really important considering security, and Inspacco provides this service from partner discovery to quality fulfillment based on the requirement",
      "Get in touch with us and see how you can utilize it for your community",
    ],
    qualityAssurance: [
...

  {
    ...
    link: "annual-services/firesystem",
    bannerImage: "/images/DetailPage/bannerLogos/fireamc.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco, as a platform, provides Fire System work and maintenance services through our certified supplier partner in residential gated communities",
      "In the event of an emergency, the fire system in a building is among the most crucial elements that must be maintained",
      "Get in touch with us and see how you can utilize it for your community",
  ...
  {
    name: "Solar",
    link: "annual-services/solar",
    bannerImage: "/images/DetailPage/bannerLogos/Solar.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco as a platform assist in providing Solar work, Solar Installation and Solar AMC services through our industry expert supplier partners ",
      "We make sure to provide complete transparency in technical knowledge,quotation and project details.",
      "Get in touch with us and see how you can utilize it for your community."
    ],
    qualityAssurance: [
      "Professional and Trained Supplier Partners",
      "Technical platform to track daily activities ",
      "Dedicated Relationship Manager for query resolution",
      "Pricing and Work Transparency ",
      "One Stop Solution for your gated community services",
      "Easy Financing and Installment option",
    ],
    inclusions: [
    ...
    faqs: [
      {
        ques: "What process you follows to suggest the right supplier partner?",
        ans: "We work as a platform where we onboard supplier partners after they qualify our set standard criteria. Based on the client requirement we suggest our top partners for the client to select.",
      },
      {
        ques:
          "What quality checks you perform for on-going services?",
        ans: `We have technical platform to track daily activities as per the agreed scope of work and checklist
        Our relationship manager does regular audit visits for the services quality. `,
      },
      {
        ques: "How to get quotation for the service?",
        ans: `You can send your service request through our website or our application or you can call on number - to provide details about the requirement and get the quotation for the same.`,
      },
      {
        ques: "What is the cost of the service?",
        ans:
          "Client need to pay only for actual service charges (e.g Housekeeping service) will be as per client requirement and scope of work. ",
      },
      {
        ques: "What is the process to handle the complaints?",
        ans:
          "You can raise the complaint through our application and our team will resolve the same OR you can raise complaint with your assigned relationship manager as well.",
      },
      {
        ques: "What are the modes of payment?",
        ans:
          "We accept both online as well cheque payments.",
      },
...

  {
    ...
    link: "annual-services/lift",
    bannerImage: "/images/DetailPage/bannerLogos/lift.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco as a platform, provide Lift maintenance and AMC services through our certified supplier partners for residential gated communities.",
      "Get in touch with us and see how you can utilize it for your community.",
  ...
  {
    name: "Swimming Pool",
    link: "annual-services/swimmingpool",
    bannerImage: "/images/DetailPage/bannerLogos/Swimming_Pool.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco as a platform assist in providing Swimming Pool maintenance, operator and Life Guard services through our certified supplier partner for your residential gated communities ",
      "We curate the supplier partners through our rigorous process and then only on-board them on our platform to provide better customer experience",
      "Contact us to know more and avail it for your gated community."
    ],
    qualityAssurance: [
      "Professional and Trained Supplier Partners",
      "Technical platform to track daily activities ",
  ...
  {
    name: "Deep Cleaning",
    link: "one_time_services/deep-cleaning",
    bannerImage: "/images/DetailPage/bannerLogos/deepcleaning.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco as a platform provides best quality deep cleaning services for your residential gated communities as per the requirement.",
      "Our technical platform helps to track scheulde of the service and provide the convenience to committee members as well as supplier partners",
      "Get in touch with us and see how you can utilize it for your community.",
...

  {
    ...
    link: "one_time_services/property_inspection",
    bannerImage: "/images/DetailPage/bannerLogos/propertyinspe.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco provides property inspection service through its technical application and set of tools which helps to create the report on the spot about the current situation of the property and also suggest about the required maintenance ",
      "Get in touch with us and see how you can utilize it for your community."
    ],
    qualityAssurance: [
      "Professional and Trained Supplier Partners",
...

  {
    ...
    link: "one_time_services/waterproofing",
    bannerImage: "/images/DetailPage/bannerLogos/waterproofing.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    stepData: {
      ...
      step1: {
        isText: false,
        isResidential: false,
        list: ["Water lekage detection", "Waterproofing"],
      },
    },
    bannerDetails: [
      "We at Inspacco provide you an end to end water leakage detection services with the help of modern tools to detect the anomalies and provide the solution For people working from home during the covid pandemic, detection of water leakage becomes important to safeguard electronic equipment and devices like switchboards, laptops, chargers, etc. ",
      "Contact us to avail it for your gated community."
    ],
    qualityAssurance: [
  ...
  {
    name: "Security",
    link: "regular-services/security",
    bannerImage: "/images/DetailPage/bannerLogos/Security.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco as a platform provides experienced and professional certified guard security supplier partners for your gated residential communities.",
      "Our platform helps to monitor daily activities and provides convenience to committee members.",
      " Get in touch with us and see how you can utilize it for your community."
    ],
    qualityAssurance: [
      "Professional and Trained Supplier Partners",
...

  {
    ...
    link: "regular-services/society_manager",
    bannerImage: "/images/DetailPage/bannerLogos/societymanager.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "For your residential gated communities, Inspacco as a platform provides experienced and competent society managers and facility managers We curate the supplier partners through our rigorous process and then only on-board them on our platform to provide better customer experience.",
      " Get in touch with us and see how you can utilize it for your community."
    ],
    qualityAssurance: [
      "Professional and Trained Supplier Partners",
  ...
  {
    name: "Accountant",
    link: "regular-services/accountant",
    bannerImage: "/images/DetailPage/bannerLogos/Accountant.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    stepData: {
      ...
      step0: {
        // list: ["Residential", "Commercial", "Other"],
        list: ["Residential", "Corporate"],
      },
      step1: {
        isText: true,
    ...
    bannerDetails: [
      ...
      "Through our supplier partner, Inspacco provides accounting services for residential gated communities From supplier discovery to fulfillment, we assist our customers and provide dedicated relationship managers to assist with all questions.",
  ...
  {
    name: "Gardening",
    link: "regular-services/gardening",
    bannerImage: "/images/DetailPage/bannerLogos/Gardening.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "For your residential gated communities, Inspacco provides an experienced and professional gardening supplier partner Through our rigorous process, we carefully curate the supplier partners before on-boarding them on our platform so that we can provide better customer service ",
  ...
  {
    name: "STP (Sewage Treatment Plant) Work",
    link: "regular-services/stpwork",
    bannerImage: "/images/DetailPage/bannerLogos/stpwork.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco as a platform provides Sewgae Treatment Plant (STP) maintenance services through our supplier partner for residential gated communities. ",
      "We curate the supplier partners through our rigorous process and then only on-board them on our platform to provide better customer experience.",
      "Get in touch with us and see how you can utilize it for your community."
    ],
    qualityAssurance: [
...

  {
    ...
    link: "regular-services/waste_management",
    bannerImage: "/images/DetailPage/bannerLogos/Waste-Management.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco as a platform assist in providing waste management services through our certified supplier partner for your residential gated communities.",
      "Contact us to know more and avail it for your gated community."
    ],
    qualityAssurance: [
      "Professional and Trained Supplier Partners",
  ...
  {
    name: "Technician",
    link: "regular-services/technician",
    bannerImage: "/images/DetailPage/bannerLogos/technician.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco offers professional and expert technician services through our supplier partner for your residential gated communities From supplier discovery to fulfillment, we assist our customers and provide dedicated relationship managers to assist with all questions. ",
  ...
  {
    name: "Fabrication",
    link: "one_time_services/fabrication",
    bannerImage: "/images/DetailPage/bannerLogos/Fabrication.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco as a platform provides best fabrication services for your residential socities as per the requirement through our expert supplier partner ",
      "Get in touch with us and see how you can utilize it for your community",
  ...
  {
    name: "Painting",
    link: "one_time_services/painting",
    bannerImage: "/images/DetailPage/bannerLogos/painting.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    stepData: {
      ...
      step1: {
        isText: false,
        isResidential: false,
        list: ["Fresh Painting", "Repainting", "Other work"],
      },
    },
    bannerDetails: [
      "Inspacco as a platform provides painting services for your residential gated communities through our industry experienced supplier partners",
      "Our technical platform will help to have complete schedule of the painting project and regular updates will be available on the platform about the work",
      "Get in touch with us and see how you can utilize it for your community.",
    ],
    qualityAssurance: [
      "Paint your home in all shades of happiness to give it a perfect finish",
  ...
  {
    name: "Tank Cleaning",
    link: "one_time_services/tank-cleaning",
    bannerImage: "/images/DetailPage/bannerLogos/tank.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco as a platform assist in providing Tank cleaning and maintenance services through our supplier partner for your residential gated communities ",
      "We curate the supplier partners through our rigorous process and then only on-board them on our platform to provide better customer experience",
      "Get in touch with us and see how you can utilize it for your community.",
  ...
  {
    name: "Sanitization",
    link: "one_time_services/sanitization",
    bannerImage: "../../images/DetailPage/bannerLogos/sanitization.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco as a platform provides sanitization, disinfection service at best prices for your residential gated communities through our certified supplier partners ",
      "Our technical platform helps to track service order details for our customer and also provides reminders to supplier parnternes to complete the service on time.",
      "Get in touch with us and see how you can utilize it for your community."
...

  {
    ...
    link: "one_time_services/building-insurance",
    bannerImage: "/images/DetailPage/bannerLogos/buildinginsurance.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco as a platform assist in providing Building Insurance services for your residential gated communities through our insurance provider partners.",
      "Get in touch with us and see how you can utilize it for your community",
    ],
    qualityAssurance: [
      "Professional and Trained Supplier Partners",
  ...
  {
    name: "Bird Netting",
    link: "one_time_services/bird_netting",
    bannerImage: "/images/DetailPage/bannerLogos/Bird_net.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco as a platform provides bird net,mosquito net services at best prices for your residential gated communities through our professional and experinced supplier partners ",
      "We curate the supplier partners through our rigorous process and then only on-board them on our platform to provide better customer experience",
      "Get in touch with us and see how you can utilize it for your community."
    ],
    qualityAssurance: [
  ...
  {
    name: "EV Solution",
    link: "annual-services/ev-solution",
    bannerImage: "/images/DetailPage/bannerLogos/EV.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco platform assists in availing Electric Vehicle (EV) Charging Solution through our expert and experinced supplier Partners",
      "We help to provide End to End solution and tracking mechnisam through tech platform",
      "Get in touch with us and see how you can utilize it for your community."
    ],
    qualityAssurance: [
      "Professional and Trained Supplier Partners",
  ...
  {
    name: "Generator",
    link: "annual-services/generator",
    bannerImage: "/images/DetailPage/bannerLogos/Generator.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco as a platform helps in providing Generator work, AMC and maintenance services through our experinced and professional supplier partners. ",
      "Get in touch with us and see how you can utilize it for your community.",
  ...
  {
    name: "Gym Equipments",
    link: "annual-services/gymequipments",
    bannerImage: "/images/DetailPage/bannerLogos/Gym.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco as a platform provides experinced and professional supplier partners to provide Gym maintenance, AMC  for your residential gated communities. ",
      "Get in touch with us and see how you can utilize it for your community.",
...

  {
    ...
    bannerImage: "/images/DetailPage/bannerLogos/modularkitchen.png",
    bredCrumb: {
      text: "Interiors",
      link: "/interiors",
    },
    stepData: {
      ...
      step1: {
        isText: false,
        isResidential: false,
        list: ["L-Shaped", "Straight", "Parallel", "U-Shaped", "Other"],
      },
    },
    bannerDetails: [
...

  {
    ...
    bannerImage: "/images/DetailPage/bannerLogos/safetydoor.png",
    bredCrumb: {
      text: "Fabrication",
      link: "/fabrication",
    },
...

  {
    ...
    link: "regular-services/housekeeping",
    bannerImage: "/images/DetailPage/bannerLogos/cleaning.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    ...
    bannerDetails: [
      "Inspacco provides an experienced and professional housekeeping service provider to provide best-in-class service to gated communities.",
      "We are a one-stop solution for all gated community maintenance needs.",
    ...
    faqs: [
     ...
     {
       ques:"Is Housekeeping Material included in the service ?",
       ans:
       "Client has the option to get the material from our suggested supplier partner as per agreed pricing."
     }
  ...
  },
  {
    ...
    bannerDetails: [
      "Inspacco appoint a society manager for your society who would set up systems in place like work scheduling, job descriptions of staff, staff manual, employee logs etc. ",
      "Contact us to avail it for your gated community"
  ...
  },
  {
    ...
    bannerImage: "/images/DetailPage/bannerLogos/inspection.png",
    bredCrumb: {
      text: "Inspection",
      link: "/inspection",
    },
  ...
  },
  {
    ...
    bannerImage: "/images/DetailPage/bannerLogos/commercialnspection.png",
    bredCrumb: {
      text: "Inspection",
      link: "/inspection",
    },
  ...
  },
  {
    ...
    bannerImage: "/images/DetailPage/bannerLogos/easydry.png",
    bredCrumb: {
      text: "Interiors",
      link: "/interiors",
    },
    stepData: {
      titles: [
        "Type of easy dry",
        "Number of easy dry required",
        "Select Date",
        "Select from available time slot",
        "Contact Details",
      ],
      step0: {
        list: ["Global easydry", "Wall stands", "Floor stands"],
      },
      step1: {
        isText: false,
        isResidential: false,
  ...
  },
  {
    ...
    bannerImage: "/images/DetailPage/bannerLogos/canopy.png",
    bredCrumb: {
      text: "Fabrication",
      link: "/fabrication",
    },
    stepData: {
      ...
      step0: {
        list: ["Roof Shed", "Parking Shed", "Other"],
      },
      step1: {
        isText: false,
        isResidential: false,
  ...
  },
  {
    ...
    bannerImage: "/images/DetailPage/bannerLogos/fencing.png",
    bredCrumb: {
      text: "Civil Work",
      link: "/civil-work",
    },
    stepData: {
      ...
      step0: {
        list: ["Wood", "Chain Link", "Metal", "Vinyl", "Other"],
      },
      step1: {
        isText: false,
        isResidential: false,
        list: ["Residential", "Commercial", "Industrial", "Other"],
      },
    },
    bannerDetails: [
  ...
  },
  {
    ...
    bannerImage: "/images/DetailPage/bannerLogos/grouting.png",
    bredCrumb: {
      text: "Civil Work",
      link: "/civil-work",
    },
    stepData: {
      ...
      step1: {
        isText: false,
        isResidential: false,
        list: ["One time", "Repetative", "Annual Contract", "Other"],
      },
    },
    bannerDetails: [
  ...
  {
    name: "Civil Work",
    link: "one_time_services/civil_work",
    bannerImage: "/images/DetailPage/bannerLogos/mason.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    },
    stepData: {
      ...
      step0: {
        list: ["Repair works", "Finishing", "Flooring", "Roofing", "Other"],
      },
      step1: {
        isText: false,
        isResidential: false,
    ...
    bannerDetails: [
      "Inspacco as a platform provides experinced and professional supplier partners to provide Civil work and repair services  for your residential gated communities",
  ...
  },
  {
    ...
    bannerImage: "/images/DetailPage/bannerLogos/tiling.png",
    bredCrumb: {
      text: "Civil Work",
      link: "/civil-work",
    },
  ...
  {
    name: "Waterproofing Service",
    link: "water-proofing/water-proofing-service",
    bannerImage: "/images/DetailPage/bannerLogos/waterproofing.png",
    bredCrumb: {
      text: "Services",
      link: "/",
    ...
    stepData: {
      ...
      step1: {
        ...
        // isResidential : false,
        // list : [
        //   "Water lekage detection",
        //   "Waterproofing",
        // ],
      },
    },
    bannerDetails: [
      "Inspacco as a platform provides water leakage detection, water proofing services for your residential gated communities through our experienced supplier partners ",
      "We curate the supplier partners then only on-board them on our platform to provide better customer experience and quality services.",
      "Get in touch with us and see how you can utilize it for your community."
    ],
    qualityAssurance: [
...

  {
    ...
    link: "water-proofing/water-leakage-detection",
    bannerImage: "/images/DetailPage/bannerLogos/waterproofing.png",
    bredCrumb: {
      text: "Water Proofing",
      link: "/water-proofing",
    ...
    bannerDetails: [
      `Building now a days are built with sensitive electric and electronic equipments.
      Detection of any kind of water leakage becomes crucial for the smooth working of the equipments. 
      It becomes important to reduce damages caused by leaks and burst or frozen pipes.
      `,
      "We at Inspacco provide you an end to end water leakage detection services with the help of modern tools to detect the anomalies and provide the solution",
      `
      For people working from home during the covid pandemic, detection of water leakage becomes important to safeguard electronic equipments and devices
      like switchboards, laptops, chargers, etc.`,
    ],
    qualityAssurance: [
      "Detection of water leakage due to faulty plumbing materials, failed connections, human error and bursting of pipes.",
      "Guarantee of 100 % hassle free service.",
      "Quality work done by a team of experienced professionals at reasonably affordable prices.",
    ],
    inclusions: [
      "Well trained and qualified team.",
      "100% satisfaction guaranteed.",
      "Save cost by identifying water leakage well in advance.",
      "We use modern tools to detect the water leakage problem",
    ],
    faqs: [
      {
        ques: " What is water leakage? And how is it detected?",
        ans: `Water leakage refers to accidental escape of water through holes or cracks in the water supply pipes. Water leaks through these cracks and can then lead 
        hazardous moulds in the walls. 
        We use Thermography as a tool to detect anomalies by reading heat patterns and thus establishing the source of water leakage and affected areas.`,
      },
      {
        ques: " How do I shcedule an appointment for this service?",
        ans: `The information and contact details for booking an appointment are available on our website www.inspacco.com. You can simply book it there or call us
        and talk to our executive to book an instant appointment.`,
      },
      {
        ques: " What is the cost of the service?",
        ans:
          "You can refer to our brochure or talk to our executive for more details about the package type and cost for the service.",
      },
      ...
      {
        ques: "Are there any inspection charges?",
        ans: `You can call to book an appointment on our website www.inspacco.com. One of our executive will get in touch with you regarding the charges
        and to solve any queries you might have.`,
      },
      {
        ques: "Do you also provide services to fix the water leakage?",
        ans:
          "Yes. We have a team of talented professionals who specialise in fixing the water leakages.",
      },
      {
        ques: "How much time does it take to identify the leak source?",
        ans:
          "It usually takes around 2 hours depending on size of the property..",
      },
    ],
  },
];

module.exports = DetailsPages;
